        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#how-it-works" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-[#039155] dark:hover:text-[#18B0BB] transition-colors">
                Como Funciona
              </a>
              <a href="#pricing" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-[#039155] dark:hover:text-[#18B0BB] transition-colors">
                Preços
              </a>
              <Link
                href="/login"
                className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-[#039155] dark:hover:text-[#18B0BB] transition-colors"
              >
                Entrar
              </Link>
              <Link
      ...
      <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-8 inline-flex items-center rounded-full border border-[#039155]/20 dark:border-[#039155]/30 bg-[#039155]/10 dark:bg-[#039155]/20 px-4 py-2 text-sm font-medium text-[#039155] dark:text-[#18B0BB] backdrop-blur-sm">
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3">
              <div className="group">
                ...
                <div className="mt-2 text-sm font-medium text-gray-600 dark:text-gray-400">Uptime</div>
              </div>
              <div className="group">
                <div className="text-4xl font-bold text-[#18B0BB]">10k+</div>
                <div className="mt-2 text-sm font-medium text-gray-600 dark:text-gray-400">Empresas Ativas</div>
              </div>
              <div className="group">
                <div className="text-4xl font-bold text-[#EC5429]">1M+</div>
                <div className="mt-2 text-sm font-medium text-gray-600 dark:text-gray-400">Mensagens Processadas</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute left-10 top-40 hidden animate-float lg:block">
          <div className="rounded-2xl bg-white dark:bg-gray-900 p-6 shadow-2xl border border-gray-200 dark:border-gray-800">
            <div className="flex items-center space-x-3">
              <div className="h-12 w-12 rounded-full bg-gradient-to-br from-[#039155] to-[#18B0BB]" />
              <div>
                <div className="font-semibold text-gray-900 dark:text-gray-100">João Silva</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Nova mensagem recebida</div>
              </div>
            </div>
          </div>
        </div>
        <div className="absolute right-10 top-60 hidden animate-float-delayed lg:block">
          <div className="rounded-2xl bg-white dark:bg-gray-900 p-6 shadow-2xl border border-gray-200 dark:border-gray-800">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Conversas Ativas</div>
                <div className="text-2xl font-bold text-[#039155] dark:text-[#18B0BB]">247</div>
              </div>
              <div className="h-12 w-12 rounded-full bg-[#039155]/10 dark:bg-[#039155]/20 flex items-center justify-center">
                <svg className="h-6 w-6 text-[#039155] dark:text-[#18B0BB]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section id="features" className="py-24 bg-gray-50 dark:bg-gray-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 grid grid-cols-1 gap-8 lg:grid-cols-3">
            {/* Feature Card 1 */}
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg dark:shadow-gray-900/50 transition-all hover:shadow-2xl hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Gestão de Contatos</h3>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg dark:shadow-gray-900/50 transition-all hover:shadow-2xl hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Conversas e Atendimento</h3>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg dark:shadow-gray-900/50 transition-all hover:shadow-2xl hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">IA Controlada</h3>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg dark:shadow-gray-900/50 transition-all hover:shadow-2xl hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Automações Inteligentes</h3>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg dark:shadow-gray-900/50 transition-all hover:shadow-2xl hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Monitoramento em Tempo Real</h3>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg dark:shadow-gray-900/50 transition-all hover:shadow-2xl hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Soberania de Dados</h3>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
          ...
          <div className="mt-20">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
              <div className="relative">
                ...
                <div className="rounded-2xl bg-gray-50 dark:bg-gray-900 p-8 pt-16 border border-gray-200 dark:border-gray-800">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Configure sua Empresa</h3>
              ...
              <div className="relative">
                ...
                <div className="rounded-2xl bg-gray-50 dark:bg-gray-900 p-8 pt-16 border border-gray-200 dark:border-gray-800">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Conecte seus Canais</h3>
                  <p className="mt-4 text-gray-600 dark:text-gray-400">
              ...
              <div className="relative">
                ...
                <div className="rounded-2xl bg-gray-50 dark:bg-gray-900 p-8 pt-16 border border-gray-200 dark:border-gray-800">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Monitore e Controle</h3>
                  <p className="mt-4 text-gray-600 dark:text-gray-400">
