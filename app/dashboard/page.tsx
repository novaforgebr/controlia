    ...
    <ProtectedLayout>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <div className="group relative overflow-hidden rounded-xl bg-white p-6 shadow-md hover:shadow-lg transition-all border border-gray-100">
            <div className="absolute top-0 right-0 h-20 w-20 bg-gradient-to-br from-[#039155]/10 to-[#18B0BB]/10 rounded-bl-full"></div>
            <div className="relative">
              <h3 className="text-sm font-medium text-gray-500">Total de Contatos</h3>
          ...
          <div className="group relative overflow-hidden rounded-xl bg-white p-6 shadow-md hover:shadow-lg transition-all border border-gray-100">
            ...
            <div className="relative">
              <h3 className="text-sm font-medium text-gray-500">Conversas Abertas</h3>
          ...
          <div className="group relative overflow-hidden rounded-xl bg-white p-6 shadow-md hover:shadow-lg transition-all border border-gray-100">
            ...
            <div className="relative">
              <h3 className="text-sm font-medium text-gray-500">Mensagens (24h)</h3>
              <p className="mt-2 text-3xl font-bold text-gray-900">
          ...
          <div className="group relative overflow-hidden rounded-xl bg-white p-6 shadow-md hover:shadow-lg transition-all border border-gray-100">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-lg font-semibold text-gray-900">{company.name}</p>
            </div>
          </div>
        </div>
