    ...
    <ProtectedLayout>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Campos Customizados</h1>
        ...
        <div className="rounded-lg bg-white shadow">
          {fields.length === 0 ? (
            <div className="p-12 text-center text-gray-500">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-900">Nenhum campo customizado</h3>
              <p className="mt-2 text-gray-600">Comece criando seu primeiro campo personalizado</p>
              <Link
                href="/contacts/custom-fields/new"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex items-center gap-4 text-sm text-gray-500">
                        <span>Chave: <code className="rounded bg-gray-100 px-1.5 py-0.5 text-xs font-mono">{field.field_key}</code></span>
