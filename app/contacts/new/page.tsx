...
export default function NewContactPage() {
  ...
  return (
    <ProtectedLayout>
      <div className="mx-auto max-w-3xl px-4 py-4 md:py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 md:mb-8">
          <h1 className="text-xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Novo Contato</h1>
          <p className="mt-1 md:mt-2 text-sm md:text-base text-gray-600 dark:text-gray-400">Adicione um novo contato ao sistema</p>
        </div>

        <form action={handleSubmit} className="space-y-4 md:space-y-6 rounded-lg bg-white dark:bg-gray-900 p-4 md:p-6 shadow dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-800">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                name="name"
                required
                className="mt-1 block w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2.5 md:py-2 text-base md:text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 shadow-sm focus:border-[#039155] focus:outline-none focus:ring-2 focus:ring-[#039155]/20 min-h-[44px] md:min-h-0"
              />
            </div>
