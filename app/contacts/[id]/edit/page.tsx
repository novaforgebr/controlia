        ...
        <form action={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                <label htmlFor="score" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Score <span className="text-gray-500 dark:text-gray-400 text-xs">(0-100)</span>
                </label>
                <div className="relative">
                  <input
                    type="number"
          ...
          <div className="rounded-lg bg-white dark:bg-gray-900 p-6 shadow-sm border border-gray-200 dark:border-gray-800">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-3 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 p-4">
                <input
                  type="checkbox"
                  id="ai_enabled"
                  name="ai_enabled"
                  ...
                  className="mt-1 h-4 w-4 rounded border-gray-300 dark:border-gray-700 text-[#039155] focus:ring-[#039155] dark:bg-gray-800"
                />
                <div className="flex-1">
                  <label htmlFor="ai_enabled" className="block text-sm font-medium text-gray-900 dark:text-gray-100 cursor-pointer">
