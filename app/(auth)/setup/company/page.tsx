      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl bg-white p-8 shadow-xl">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Configurar Empresa</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-3 text-gray-900 placeholder-gray-500 shadow-sm transition-colors focus:border-[#039155] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#039155]/20 disabled:bg-gray-100 disabled:text-gray-500"
