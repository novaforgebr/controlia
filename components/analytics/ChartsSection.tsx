  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:gap-6 lg:grid-cols-2">
      ...
      <div className="rounded-lg bg-white dark:bg-gray-900 p-4 md:p-6 shadow dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-800">
        <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3 md:mb-4">Conversas por Status</h3>
      ...
      {/* Contatos por Status */}
      <div className="rounded-lg bg-white dark:bg-gray-900 p-4 md:p-6 shadow dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-800">
        <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3 md:mb-4">Contatos por Status</h3>
        <div className="space-y-3">
      ...
      {/* Conversas por Canal */}
      <div className="rounded-lg bg-white dark:bg-gray-900 p-4 md:p-6 shadow dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-800">
        <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3 md:mb-4">Conversas por Canal</h3>
        <div className="space-y-3">
      ...
      <div className="rounded-lg bg-white dark:bg-gray-900 p-4 md:p-6 shadow dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-800">
        <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3 md:mb-4">Mensagens (Últimos 30 dias)</h3>
        <div className="flex items-end justify-between h-32 md:h-48 gap-0.5 md:gap-1 overflow-x-auto">
          {messagesChartData.length > 0 ? (
            messagesChartData.map((data, index) => (
              <div key={index} className="flex-1 min-w-[20px] flex flex-col items-center">
                ...
                />
                <span className="text-[10px] md:text-xs text-gray-500 dark:text-gray-400 mt-1 transform -rotate-45 origin-top-left whitespace-nowrap">
      ...
      {Object.keys(aiActionsCount).length > 0 && (
        <div className="rounded-lg bg-white dark:bg-gray-900 p-4 md:p-6 shadow dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-800 lg:col-span-2">
          <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3 md:mb-4">Ações da IA</h3>
          <div className="grid grid-cols-2 gap-3 md:gap-4 sm:grid-cols-4">
            {Object.entries(aiActionsCount).map(([action, count]) => (
              <div key={action} className="rounded-lg bg-gradient-to-br from-[#039155]/10 to-[#18B0BB]/10 dark:from-[#039155]/20 dark:to-[#18B0BB]/20 p-3 md:p-4">
                <p className="text-xs md:text-sm font-medium text-gray-600 dark:text-gray-300 capitalize break-words">{action.replace('_', ' ')}</p>
                <p className="mt-1 md:mt-2 text-xl md:text-2xl font-bold text-[#039155] dark:text-[#18B0BB]">{count}</p>
              </div>
            ))}
          </div>
        </div>
